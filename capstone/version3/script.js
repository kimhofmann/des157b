...
async function submitAnswer(answer) {
  ...
  document.getElementById("answerText").innerHTML = `Percentage of users who answered ${answer}: ${percentage.toFixed(2)}%`;
...
document.getElementById("submissionForm").addEventListener("submit", function(event) {
  ...
  thankYouMessage.innerHTML = "Thank you for submitting a question";
