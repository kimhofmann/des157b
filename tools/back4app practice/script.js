...
Parse.initialize("qJgoqZ1N963tpQE62yqNg2dYFQe9vhaw8Zw9nZwP","llcyAoD52aFB69H769c2oOwfmeTvm0aJl8Jb7l5M"); //PASTE HERE YOUR Back4App APPLICATION ID AND YOUR JavaScript KEY
...
async function updateRecord(recordId){
    ...
    try {
        ...
        try {
           await object.save();
           editedFriendForm.className = "edit-friend-offscreen";
           friendList.innerHTML = '';
           displayFriends();
        } catch (error) {
